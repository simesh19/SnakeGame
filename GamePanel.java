...
public class GamePanel extends JPanel implements ActionListener
{
    ...
    public void draw(Graphics g) 
    {
        ...
        if(running)
        {
            ...
            for(int i = 0; i < bodyParts; i++)
            {
                ...
                g.drawString("Scored : "+applesEaten,(SCREEN_WIDTH - metrics.stringWidth("Scored : "+applesEaten))/3,g.getFont().getSize());
                */
            }
        }
        else
    ...
    public void gameOver(Graphics g) 
    {
        ...
        g.drawString("Scored : "+applesEaten,(SCREEN_WIDTH - metrics1.stringWidth("Scored : "+applesEaten))/3,g.getFont().getSize());
